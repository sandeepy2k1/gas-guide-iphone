...
@synthesize list;
- (void)viewDidLoad {	// * * * * Problems: Uncommon * * * *
    NSArray *array = [[NSArray alloc] initWithObjects:
					  @"Acute Stridor",				// Option 0
                      @"Anaphylaxis",				// Option 1
                      @"Aspiration",				// Option 2
					  @"Cardiac Arrest",			// Option 3
					  @"Cardiac Devices",			// Option 4
					  @"Crisis Algorithm",			// Option 5
					  @"Dental Injuries",           // Option 6
					  @"Hemorrhage & Transfusion",	// Option 7
					  @"Laryngospasm",              // Option 8
					  @"Local Anesthetic Toxicity", // Option 9
					  @"Malignant Hyperthermia",	// Option 10
					  @"Tension Pneumothorax",		// Option 11
                      nil];
    self.list = array;
    [array release];
    [super viewDidLoad];
