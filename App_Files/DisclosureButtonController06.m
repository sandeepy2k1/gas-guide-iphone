...
- (void)viewDidLoad {	// * * * * Pharmacology * * * *
    NSArray *array = [[NSArray alloc] initWithObjects:
					  @"Analgesics",            // Option 0
					  @"Anesthetics: Inhalation",// Option 1
					  @"Anesthetics: Intravenous",// Option 2
					  @"Anesthetics: Local",     // Option 3
					  @"Antibiotics: Adults",	// Option 4
					  @"Antibiotics: Children",	// Option 5
					  @"Infusions: Adult",		// Option 6
					  @"Infusions: Children",	// Option 7
					  @"Medication Overview",	// Option 8
					  @"Muscle Relaxants",		// Option 9
					  @"Side Effects: Herbals",	// Option 10
					  @"Side Effects: Interactions",// Option 11
					  @"Side Effects: Medications",// Option 12
					  @"Side Effects: QT Drugs",// Option 13
					  nil];
    self.list = array;
    [array release];
    [super viewDidLoad];
